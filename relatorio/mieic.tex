...
%%----------------------------------------
\title{Interação remota através de manipulação direta para aplicações com multi-utilizadores em ecrãs públicos}
\author{Maria João Barreira}

%% Uncomment next line for date of submission
\thesisdate{28 de julho de 2014}

%% Uncomment next line for copyright text if used
%\copyrightnotice{Nome do Autor, 2008}

\supervisor{Orientador}{Prof. Doutor Maria Teresa Galvão Dias}
...
\committeemember{Presidente}{Prof. Doutor Jorge Manuel Gomes Barbosa}
\committeemember{Arguente}{Prof. Doutor José Benjamim Ribeiro da Fonseca}
\committeemember{Vogal}{Prof. Doutor Maria Teresa Galvão Dias}
\signature
