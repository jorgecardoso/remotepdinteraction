function PDRemoteWidget (serverAddress, applicationId, widgetRelativeUrl, iconAbsoluteUrl) {
    ...
    */
	...
	socket.on('connect', function(){
		...
		socket.emit('APP_READY', {id: encodeURIComponent(this.applicationId), widgetUrl:filename, iconUrl:iconAbsoluteUrl});
